...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// the variable "internal" is within the scope of myFunction, like the function nestedFunction()... and because they are both within the same scope, nestedfunction can utilize the variable "internal";
...
function greeting(firstname, lastname){
  ...
  console.log(`test3a`,consume(2, 2, add)); // 4
  console.log('test3b',consume(10, 16, multiply)); // 160
  console.log('test3c',consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
...
class CuboidMakerTwo{
  ...
  // converting volume prototype
  volume() {
    return this.length * this.width * this.height;
  }
  // converting surfaceArea prototype
  surfaceArea() {
    return 2 * (this.length * this.width + this.length * this.height + this.width *this.height);
  }
}
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
console.log(`FinalTesta`,cuboidTwo.volume()); // 100
console.log(`FinalTestb`,cuboidTwo.surfaceArea()); // 130
